...
function btncfivetone(){
    var cfivetone = document.getElementById('cfivetone');
    var x = cfivetone.value;
    $.ajax({
            //the url to send the data to
            url: "update.php",
            //the data to send to
            // data: {id : $id, lang: $lang},
            data: {courtno : '5', score: x, total: 'totalone'},
            //type. for eg: GET, POST
            type: "POST",
            //on success
            success: function(data){
...
function btncfivettwo(){
    var cfivettwo = document.getElementById('cfivettwo');
    var x = cfivettwo.value;
    $.ajax({
            //the url to send the data to
            url: "update.php",
            //the data to send to
            // data: {id : $id, lang: $lang},
            data: {courtno : '5', score: x, total: 'totaltwo'},
            //type. for eg: GET, POST
            type: "POST",
            //on success
            success: function(data){
